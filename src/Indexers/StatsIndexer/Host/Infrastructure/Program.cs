...
using Cinder.Indexers.StatsIndexer.Host.Infrastructure.Hosting;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;

namespace Cinder.Indexers.StatsIndexer.Host.Infrastructure
{
        ...
        public static async Task<int> Main(string[] args)
        {
            HostWrapper hostWrapper = new HostWrapper
            {
                DefaultBuilder = new HostBuilder().ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddHostedService<StatsIndexerService>();
